...
declare type RouterTargetValue = View | string | RouterMap
declare type RouterMap = Record<string, RouterTargetValue>
 ...
 */
declare class FormView extends View {
    /**
...
declare class Page extends View {
  /**
